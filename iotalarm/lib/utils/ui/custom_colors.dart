...
class CustomColors {
  ...
  static const cpone = {
    'blue1': Color(0xFF3d5a80),
    'blue2': Color(0xFF98c1d9),
    'cyan':  Color(0xFFe0fbfc),
    'orange':Color(0xFFee6c4d),
    'grey':  Color(0xFF293241)
  };

  static const cptwo = {
    'orangePeel'   :Color(0xFFff9f1c),
    'mellowApricot':Color(0xFFffbf69),
    'white'        :Color(0xFFffffff),
    'lightCyan'    :Color(0xFFcbf3f0),
    'tiffanyBlue'  :Color(0xFF2ec4b6),
  };
